...
- (void)viewDidLoad {
    ...
    mSearchBar.placeholder = @"请输入城市中文名或者拼音";//相当于一个占位符，等输入文字时就会消失
    mSearchBar.searchBarStyle = UISearchBarStyleDefault;//设置搜索框的样式
    //在键盘上部添加一个隐藏按钮
    ...
    mTableView.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;//自适应
